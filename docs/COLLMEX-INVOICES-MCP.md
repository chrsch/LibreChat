...
The authoritative system prompt is maintained in [`agents/rechnungsbucher.md`](../agents/rechnungsbucher.md) (section 6.3). Copy the prompt from there to keep a single source of truth.
